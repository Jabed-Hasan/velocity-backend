...
router.get('/track/id/:orderId', auth(USER_ROLE.admin, USER_ROLE.user), orderController.trackOrderById);

// Admin-only tracking management routes
router.patch('/track/:orderId', auth(USER_ROLE.admin), orderController.updateTracking);
